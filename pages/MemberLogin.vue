<template>
  ...
  >
    ...
    <!-- Büyük ekranda görünüm -->
      <div
        class="hidden lg:flex absolute drop-shadow-2xl/80 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 overflow-hidden h-165 rounded-4xl "
      >
        <div
          class="w-150 col-span-2 drop-shadow-xl/50 flex items-center justify-end rounded-l-4xl"
        >
          
            <NuxtImg src="Login/login-1.png" class="h-full w-full object-cover" />

        
        </div>
        <div class="w-115 rounded-r-4xl bg-white ">
          <div
            class="bg-gradient-to-r from-[#1C3E7E] to-[#1b9a88] w-55 mt-3 text-white px-4 py-4 rounded-r-4xl tracking-widest"
          >
            <h2>Tekrar hoş geldiniz!</h2>
          </div>
          <div class="flex flex-col gap-14 mt-18 px-10 text-[#06475d]">
            <h2 class="font-extrabold text-xl tracking-wider">Hesabına Giriş Yap</h2>
            ...
            <div class="relative">
              ...
              />
              <div
                class="absolute bottom-0 left-0 h-[2px] w-full bg-gradient-to-r from-[#1b9a88] to-[#1C3E7E]"
              ></div>
            </div>
            <div class="relative">
              <input
            ...
            <div class="flex-center flex-col gap-3">
              <NuxtLink>
                <button
                  class="bg-gradient-to-r from-[#1b9a88] to-[#1C3E7E] rounded-full text-white text-xl py-3 w-35"
                >
                  Giriş Yap
                </button>
              </NuxtLink>
              <NuxtLink to="/MemberRegister">
...
<div class="flex lg:hidden absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 drop-shadow-2xl/80 bg-black overflow-hidden w-[90%] max-w-md h-165 rounded-4xl">
  <NuxtImg
          src="Login/login.png"
          class="object-cover grayscale opacity-20"
        />
        <div
...
const accounts = [
  { icon: "fa-brands:facebook-f", text: "Facebook ile devam et" },
  { icon: "pajamas:twitter", text: "Twitter ile devam et" },
  { icon: "devicon:google", text: "Google ile devam et" },
  { icon: "logos:paypal", text: "Paypal ile devam et" },
];
</script>
